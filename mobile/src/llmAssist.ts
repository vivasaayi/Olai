...
export type AssistMode = "summary" | "kids" | "method" | "critique" | "custom";
...
export function buildAssistPrompt(book: Book, chapter: Chapter | undefined, section: Section, mode: AssistMode, question: string) {
  return [
...
export function localAssistFallback(prompt: string) {
  return [
    ...
    "",
    "Use the prompt below with LM Studio, Ollama OpenAI-compatible server, or your remote LLM gateway:",
    "",
    prompt,
  ].join("\n");
}
